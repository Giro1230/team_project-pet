...
<div id="body-content">
	...
	<sectionthree>
	<h1 class="best">
		<a href="/"><span># 장난감</span> [훈련용품]</a>
	</h1>
	<div class="item_list">
		<c:forEach var="ilist" items="${list }">
			<div class="st_item">
				<ul>
					<li class="item1"><div class="m_item1"><img src="/resources/images/toystraining/${ilist.product_img }" style="width: 350px;height: 300px; "></div></li>
